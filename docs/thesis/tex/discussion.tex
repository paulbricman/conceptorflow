...
\caption{NSC output graph after undervaluing target children count per node.}\label{fig:too_much_pruning}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.45\textwidth]{img/short_run.png}
\caption{NSC output graph after undervaluing arc pruning.}\label{fig:short_run}
\end{figure}
